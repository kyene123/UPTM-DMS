								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											...
											<a href="book-hostel.php" class="block-anchor panel-footer text-center">Book Now &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											...
											<a href="sticker.php" class="block-anchor panel-footer text-center">Apply Now &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												...
												<div class="stat-panel-number h1 ">Message</div>

												</div>
											</div>
											<a href="emp_msg.php" class="block-anchor panel-footer text-center">Send Message &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
