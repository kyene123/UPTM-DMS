...
$query="insert into  rooms (seater,room_no,fees,Hno) values(?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('isis',$seater,$roomno,$fees,$hno);
$stmt->execute();
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Room/House</h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Add Room/house</div>
									<div class="panel-body">
									<?php if(isset($_POST['submit']))
{ ?>
<p style="color: red" hidden><?php echo htmlentities($_SESSION['msg']); ?><?php echo htmlentities($_SESSION['msg']=""); ?></p>
<?php } ?>
...
<div class="col-sm-8">
<input type="text" class="form-control" name="hno" id="hno" value="" required="required">
</div>
</div>
