...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/back.png);">
		<div class="form-content">
			<div>&nbsp;</div>
			<div>&nbsp;</div>
			
			<div class="logo1" name"logo1" align="center">
				<img src="img/logouptm.png" width="287" height="200" class="logo img-responsive" >
				</div>
			<div class="container">
				
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x text" >Hostel Management System</h1>
						<div class="transbox">
...
<p> Brought To You By <a href="https://code-projects.org/">UPTM</p>
</footer> </div>
