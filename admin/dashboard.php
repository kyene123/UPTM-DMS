									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-danger text-light">
												...
												<div class="stat-panel-number h2 ">Available Rooms</div>

												</div>
											</div>
											<a href="available_room.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Faculty</div>
												</div>
											</div>
